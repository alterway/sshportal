...
//
// Vendored from https://github.com/moby/moby/blob/v28.5.2/pkg/namesgenerator/names-generator.go
// to avoid depending on the full Docker go package
...
var (
	...
	right = [...]string{
		...
		// Homi J Bhabha - was an Indian nuclear physicist, founding director, and professor of physics at the Tata Institute of Fundamental Research. Colloquially known as "father of Indian nuclear program"- https://en.wikipedia.org/wiki/Homi_J._Bhabha
		"bhabha",
		...
		// Dame Susan Jocelyn Bell Burnell - Northern Irish astrophysicist who discovered radio pulsars and was the first to analyze them. https://en.wikipedia.org/wiki/Jocelyn_Bell_Burnell
		"burnell",
		...
		// Vinton Gray Cerf - American Internet pioneer, recognized as one of "the fathers of the Internet". With Robert Elliot Kahn, he designed TCP and IP, the primary data communication protocols of the Internet and other computer networks. https://en.wikipedia.org/wiki/Vint_Cerf
		"cerf",
		...
		// Satish Dhawan - Indian mathematician and aerospace engineer, known for leading the successful and indigenous development of the Indian space program. https://en.wikipedia.org/wiki/Satish_Dhawan
		"dhawan",
		...
		// Mae Carol Jemison -  is an American engineer, physician, and former NASA astronaut. She became the first black woman to travel in space when she served as a mission specialist aboard the Space Shuttle Endeavor - https://en.wikipedia.org/wiki/Mae_Jemison
		"jemison",
		...
		// Anne Laura Dorinthea McLaren - British developmental biologist whose work helped lead to human in-vitro fertilization. https://en.wikipedia.org/wiki/Anne_McLaren
		"mclaren",
		...
		// Helen Brooke Taussig - American cardiologist and founder of the field of pediatric cardiology. https://en.wikipedia.org/wiki/Helen_B._Taussig
		"taussig",
		...
		// Sir Mokshagundam Visvesvaraya - is a notable Indian engineer.  He is a recipient of the Indian Republic's highest honor, the Bharat Ratna, in 1955. On his birthday, 15 September is celebrated as Engineer's Day in India in his memory - https://en.wikipedia.org/wiki/Visvesvaraya
		"visvesvaraya",
